...
export const BreadCrumbs = (props) => {
	let { match, insuranceDetail, status, history } = props;
	return (
		<>
					...
					<div className="d-flex justify-content-start align-items-center">
						<div className="breadcrums d-flex align-items-center flex-wrap">
							<ul>
								...
								<li className="mr-1" class="active">
									<Link to={`${public_url.insurance_detail}/${match.params.leadcode}`}>
										Insurance Details
                      </Link>
								</li>
							</ul>
							{insuranceDetail && insuranceDetail.applicant && insuranceDetail.applicant.loannumber && (
								<span className="note ml-3 mt-md-0 mt-3">
									Reference ID : {insuranceDetail.applicant.loannumber}
								</span>
							)}
						</div>
					</div>
