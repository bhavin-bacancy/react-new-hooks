...
export class Loginchecklist extends Component {
	state = {
		checklistDetails: {},
		documents: "",
		docs: ""
						...
						<div className="bg-white p-md-4 p-1">
							...
							<div className="p-2">
								<div className="d-flex mt-3">
									...
									{allData && allData.firmName ? allData.firmName : allData && allData.customerName}
									</p>
									<p className="text-green ml-5">({allData && allData.typeOfEntity})</p>
								</div>
								<div
									className="d-flex"
								...
								<div className="pl-4 pr-2 mt-2 case">
									<div className="p-2">
										<div className="row">
											<div className="col-lg-8 col-md-6 pl-4">
												{ApplicationForm &&
													ApplicationForm.map(res => (
														<li
															className="text-l-priamry mt-2 mybullet"
											...
											<div className="col-lg-8 col-md-6">
												...
												<div className="pl-2">
													...
													{AddressProofNonIndividual &&
														AddressProofNonIndividual.length === 0 ? (
															<li>No Documents Submitted</li>
														) : (
															AddressProofNonIndividual &&
												...
												<div className="pl-2">
													{SignatureVerificationNonIndividual &&
														SignatureVerificationNonIndividual.length === 0 ? (
															<li>No Documents Submitted</li>
														) : (
															SignatureVerificationNonIndividual &&
										...
										<div className="row">
											<div className="col-lg-8 col-md-6">
												...
												<div className="pl-2">
													{FinancialIncome && FinancialIncome.length === 0 ? (
														<li>No Documents Submitted</li>
													) : (
															FinancialIncome &&
                            ...
                            Technical.map(res => (
                              ...
                              >
								...
								<div className="row justify-content-end mt-4 pr-0 mb-2">
									...
									<Link to={`${public_url.signtory_section}/${this.state.allData && this.state.allData.loannumber}/${match.params.leadcode}/${match.params.mobileno}`}>
										<button className="btn btn-green btn-rounded text-white ls-1 py-1 px-5 cursor-pointer fs-16 mr-3">
											Next
                  </button>
									</Link>
