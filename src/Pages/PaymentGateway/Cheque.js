    ...
    return (
      <React.Fragment>
                    ...
                    <div className="col-sm-12 col-lg-8 col-xl-6 create-lead-form d-flex align-items-center">
                      <Input
                        ...
                        onChangeFunc={(name, value, error) => {
                          this.onInputChange(name, value.toUpperCase(), error);
                        }}
                      ...
                      <span
                        ...
                        onClick={() => !errors.ifscCode && this.OnCheckClick()}
                      >
                        Check
                      </span>
                    </div>
                      ...
                      <div className="select w-100">
                        <Input
                          ...
                          validationFunc={(name, error) => {
                            if (
                              new Date(minDate) < new Date(paymentDate) &&
                  ...
                  <div className="form-group row align-items-start">
                    ...
                    <div className="col-sm-12 col-lg-8 col-xl-6 create-lead-form">
                      <span className="colorGreen font-weight-bold">
                        {" "}
                        ₹ {this.state.form.amount ? this.state.form.amount : ""}
                      </span>
                    </div>
                  </div>
                  <div className="form-group row align-items-start">
        ...
        <div className="text-primary  ml-lg-4 text-left mb-3">
          Note : These fees are applicable to process the profile and therefore
          non-refundable irrespective of Loan approval or rejection when you
          proceed.
        </div>
