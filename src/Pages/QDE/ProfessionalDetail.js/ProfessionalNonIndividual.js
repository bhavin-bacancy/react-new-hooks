...
class ProfessionalNonIndividual extends React.Component {
	constructor() {
		super();
		this.state = {
	...
	FormUpdate = () => {
		...
		let { form } = this.state;
		if (selectedEntity == 4 || selectedEntity == 2 || selectedEntity == 3) {
			form = cloneDeep(initFormCin);
		} else if (selectedEntity == 5 || selectedEntity == 7) {
			form = cloneDeep(initForm);
...
export default withRouter(ProfessionalNonIndividual);
