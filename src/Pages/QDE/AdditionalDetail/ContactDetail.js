...
class ContactDetails extends React.Component {
  ...
  render() {
    ...
    let { emailId, alternateMobileNumber, errors } = form;
    let CurrentAddressFormStatus = false;
    if (emailId && alternateMobileNumber) {
          ...
          <div class="col-sm-12">
            ...
            {/* <div class="row justify-content-end mt-3 pr-0 mt-lg-0">
              {!saveForm && CurrentAddressFormStatus && (
                <button
                  disabled=""
                  class="btn btn-secondary btn-rounded ls-1 py-1 px-5 cursor-pointer fs-16 mr-3"
                >
                  Cancel
                </button>
              )}
